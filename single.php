...
if(isset($_POST['url'])){
	$url = $_POST['url'];
	$url = trim($url);
	$dataurl = "https://api.facebook.com/method/fql.query?query=select%20total_count,like_count,comment_count,share_count,click_count%20from%20link_stat%20where%20url=%27".$url."%27&format=json";
...
<head>
	...
	<style>
		...
		.footer{font-size:14px;margin-top:15%;text-align:center}
	</style>
	...
	<div class="main">
		...
		<div class="counter">
			...
			<form action="" method="post">
				<input type="text" name="url" <?php if(isset($url)): ?> value='<?php echo $url; ?>' <?php else: ?> <?php endif; ?> placeholder='Please Enter Any URL' class="input" />
		...
		<div class="result">
			<table border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td><?php echo $data['share_count']; ?></td>
		...
		<?php endif; ?>
		<p>Wanna Check Bulk? <a href="bulk.php">Click Here</a></p>
